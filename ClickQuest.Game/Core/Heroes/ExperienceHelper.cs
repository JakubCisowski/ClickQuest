...
namespace ClickQuest.Game.Core.Heroes
{
	public static class ExperienceHelper
	{
		...
		{
			int heroLvlMonsterExperience = (int) Math.Ceiling(MonsterMaxHealthToExperienceRatio * MonsterHpValuesPerLvl[User.Instance.CurrentHero.Level]);
