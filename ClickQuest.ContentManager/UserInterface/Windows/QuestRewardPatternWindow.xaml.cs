...
public partial class QuestRewardPatternWindow : Window
{
	...
	{
		var oldPatternIndex = _quest.QuestRewardPatterns.IndexOf(_quest.QuestRewardPatterns.FirstOrDefault(x => x.QuestRewardId == _pattern.QuestRewardId && x.QuestRewardType == _pattern.QuestRewardType));
