...
namespace ClickQuest.Game.Extensions.UserInterface.ToolTips
{
	public static class HeroStatsToolTipController
	{
		public static ToolTip GenerateSpecializationToolTip(SpecializationType typeOfGeneratedSpecialization, int nextUpgrade)
		{
			...
			switch (typeOfGeneratedSpecialization)
			{
				case SpecializationType.Blessing:
				{
					...
					toolTipBlock.Inlines.Add(new Run($"{User.Instance.CurrentHero?.Specialization.SpecializationBuffs[SpecializationType.Blessing]}")
					{
				...
				case SpecializationType.Clicking:
				{
					...
					toolTipBlock.Inlines.Add(new Run($"{User.Instance.CurrentHero?.Specialization.SpecializationBuffs[SpecializationType.Clicking]}")
					{
					...
					toolTipBlock.Inlines.Add(new Run($"Next upgrade (+{Specialization.SpecClickingBuffBonus} on-hit damage) in")
					{
						FontFamily = fontFamilyRegularItalic,
						Foreground = (SolidColorBrush) Application.Current.FindResource("BrushGray3")
					});
				...
				case SpecializationType.Crafting:
				{
					...
					toolTipBlock.Inlines.Add(new Run($"{User.Instance.CurrentHero?.Specialization.SpecCraftingText}")
					{
						FontFamily = fontFamilyRegularBlackItalic,
				...
				case SpecializationType.Trading:
				{
					...
					toolTipBlock.Inlines.Add(new Run($"{User.Instance.CurrentHero.Specialization.SpecializationBuffs[SpecializationType.Trading]}")
					{
						FontFamily = fontFamilyRegularBlackItalic
					});
				...
				case SpecializationType.Questing:
				{
					...
					toolTipBlock.Inlines.Add(new Run($"{User.Instance.CurrentHero.Specialization.SpecializationBuffs[SpecializationType.Questing]}")
					{
						FontFamily = fontFamilyRegularBlackItalic
					});
					toolTipBlock.Inlines.Add(new Run("%)"));
					...
					toolTipBlock.Inlines.Add(new Run($"Maximum reduction value is {Specialization.SpecQuestingBuffLimit}%")
					{
						FontFamily = fontFamilyRegularItalic,
						Foreground = (SolidColorBrush) Application.Current.FindResource("BrushGray5")
					});
				...
				case SpecializationType.Dungeon:
				{
					...
					toolTipBlock.Inlines.Add(new Run($"{User.Instance.CurrentHero?.Specialization.SpecializationBuffs[SpecializationType.Dungeon]}")
					{
						FontFamily = fontFamilyRegularBlackItalic
					});
		...
		public static ToolTip GenerateHeroInfoToolTip(HeroRace heroRace, HeroClass heroClass)
		{
			...
			{
				FontSize = fontSizeToolTipname,
				Foreground = ColorsController.GetHeroClassColor(User.Instance.CurrentHero.HeroClass)
			});
