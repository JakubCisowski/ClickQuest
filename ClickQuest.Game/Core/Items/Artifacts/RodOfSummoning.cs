...
namespace ClickQuest.Game.Core.Items.Artifacts
{
	...
	public class RodOfSummoning : ArtifactFunctionality
	{
		...
		private int _stacksCount = 0;
		private int _familiarAttacksCount = 0;
		...
		{
			double totalFamiliarDamageModifier = BaseFamiliarClickDamageModifier + FamiliarClickDamageModifierPerStack * _stacksCount;
			int damage = (int) Math.Ceiling(User.Instance.CurrentHero.ClickDamage * totalFamiliarDamageModifier);
